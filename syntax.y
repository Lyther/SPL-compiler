...
ExtDef: Specifier ExtDecList SEMI { $$ = new_node("ExtDef", NULL, $1->lineno, $1, $2, $3, NULL, NULL, NULL, NULL); }
	...
	| Specifier error { $$ = new_node("ERR", "semi error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("semi ';' is expected"); };
...
FunDec: ID LP VarList RP { $$ = new_node("FunDec", NULL, $1->lineno, $1, $2, $3, $4, NULL, NULL, NULL); }
	...
	| ID LP error { $$ = new_node("ERR", "parenthesis error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("parenthesis ')' is expected"); };
...
Matched_Stmt: IF LP Exp RP Matched_Stmt ELSE Matched_Stmt { $$ = new_node("Matched_Stmt", NULL, $1->lineno, $1, $2, $3, $4, $5, $6, $7); }
	...
	| Exp error { $$ = new_node("ERR", "semi error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("semi ';' is expected"); }
	| RETURN Exp error { $$ = new_node("ERR", "semi error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("semi ';' is expected"); };
	| IF LP Exp Matched_Stmt ELSE Matched_Stmt { $$ = new_node("ERR", "parenthesis error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("parenthesis ')' is expected"); }
	| WHILE LP Exp Stmt { $$ = new_node("ERR", "parenthesis error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("parenthesis ')' is expected"); };
Open_Stmt: IF LP Exp RP Stmt { $$ = new_node("Open_Stmt", NULL, $1->lineno, $1, $2, $3, $4, $5, NULL, NULL); }
	...
	| IF LP Exp Stmt { $$ = new_node("ERR", "parenthesis error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("parenthesis ')' is expected"); }
	| IF LP Exp Matched_Stmt ELSE Open_Stmt { $$ = new_node("ERR", "parenthesis error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("parenthesis ')' is expected"); };
...
Def: Specifier DecList SEMI { $$ = new_node("Def", NULL, $1->lineno, $1, $2, $3, NULL, NULL, NULL, NULL); }
	| Specifier DecList { $$ = new_node("ERR", "semi error", $1->lineno, NULL, NULL, NULL, NULL, NULL, NULL, NULL); printerr("semi ';' is expected"); };
...
int main(int argc, char **argv) {
	if (argc == 2) {
		...
		// printf("\nParsing start...\n");
		// yydebug = 1;
		if (!yyparse())	return 0; /* printf("Parsing complete successfully!\n\n"); */
